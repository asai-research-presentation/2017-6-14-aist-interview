...
#+BEGIN_EXPANDED
1. これまでの研究業績
   1. "Fully Automated Cyclic Planning for Large-Scale Manufacturing Domains"※1. In ICAPS2014.
   2. "Solving Large-Scale Planning Problems by Decomposition and Macro Generation"※1. In ICAPS2015.
   3. "Tiebreaking Strategies for A* Search: How to Explore the Final Frontier"※1. In AAAI-2016. (JSAI 学生奨励賞)
   ...
   5. "Exploration Among and Within Plateaus in Greedy Best-First Search"※1. In ICAPS2017.
   6. "Efficient Optimal Search under Expensive Edge Cost Computation"※2. In IJCAI-2017.
...
4. *難関論文誌(12%)*   "Tie-Breaking Strategies for Cost-Optimal Best First Search". Journal of Artificial Intelligence Research 58 (2017): 67-121.
   1. (3.) に加え タイブレーキング と 非最適コスト探索の関連性を指摘
   2. さらに性能向上
