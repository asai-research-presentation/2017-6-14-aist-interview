...
#+title: 問題分割と対称性検知を用いた、 高速なプランニングアルゴリズムの開発
#+author: 
#+include: "head.org"
#+LINK: img file:img/%s
...
1. これまでの研究業績 : 査読付き学会論文
   ...
   4. *難関国際会議* _Asai, M._ and Fukunaga, A. Tiebreaking Strategies for Classical Planning Using A* Search. In /Proceedings of the 30th AAAI Conference on Artificial Intelligence(*AAAI*)/, February 2016. */採択率26%/*
