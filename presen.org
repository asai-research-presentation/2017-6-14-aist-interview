...
+ いま興味・関心がある分野とは限らない
  + やりたいことはいくらでもある (進化計算/SAT/学習/知識表現/HCI)
+ 今の自分は小粒研究者 → 本物の一流ビッグネームへ。
#+end_larger
...
#+begin_smaller
 ...
 |----------+------------------------+--------------------------+------------------------------+-------------------------------+--------------------------------|
 | ACP      | 難関学会               | ループの概念を検出       | 超大規模問題に初めてタックル | 産業応用                      | 人間プログラマでは追いつかない |
 |----------+------------------------+--------------------------+------------------------------+-------------------------------+--------------------------------|
 | CAP      | 難関学会               | 問題分割統合手法         | より汎用                     | 産業応用                      | より一般化したい               |
 |----------+------------------------+--------------------------+------------------------------+-------------------------------+--------------------------------|
 | AAAI16   | 査読者2/3 人に絶賛     | 同コストのノードの分類   | 70年代からの定説を覆す       | コスト0は実応用によく使われる | 下界以外で改善したかった       |
 | ・JAIR17 | (+ JSAI学生奨励賞)     |                          | 通常と異なる方法で性能改善   | 基礎技術                      |                                |
 |----------+------------------------+--------------------------+------------------------------+-------------------------------+--------------------------------|
 | IJCAI17  | 難関学会               | 問題設定(辺コストが未知) |                              | 医療福祉での実問題            | 全ての辺を計算できない         |
 |----------+------------------------+--------------------------+------------------------------+-------------------------------+--------------------------------|
 | ICAPS17  | 難関学会               | 均一化手法の整理・高速化 |                              |                               | 理解したい/性能向上            |
 |----------+------------------------+--------------------------+------------------------------+-------------------------------+--------------------------------|
