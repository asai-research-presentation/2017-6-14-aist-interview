...
#+begin_span7
#+begin_larger
+ 論理による推論 :: 命題論理, 一階述語論理, 時制論理, ベイズ論理 etc
+ 組合せ爆発 :: 有限のシンボルでも発生
...
+ AAMAS マルチエージェント, CSP : 九大 横尾誠先生
+ ERATO (同じくグラフ探索をやっているが、explicit graph) : 河原林健一先生 (NII), 秋葉先生
+ ゲーム系 金子先生 (総合文化研究科)
